    ...
    {!audiocallState.isStarted ?
      <><div className={choose.categories}>
          ...
          <div className={choose.categoriesBtnGroup}>
            <button className={choose.categoriesBtn} onClick={() => handleStart(0)}>1</button>
            <button className={choose.categoriesBtn} onClick={() => handleStart(1)}>2</button>
            <button className={choose.categoriesBtn} onClick={() => handleStart(2)}>3</button>
            <button className={choose.categoriesBtn} onClick={() => handleStart(3)}>4</button>
            <button className={choose.categoriesBtn} onClick={() => handleStart(4)}>5</button>
            <button className={choose.categoriesBtn} onClick={() => handleStart(5)}>6</button>
          </div>
      </div></>
      : null}
    <div id='audio-call'>
