        ...
        <div className={style.resultWrapper && style.answersContainer}>
          <ul className={style.rightAnswList}>
            <div className={style.audioCorrect}>
              <p className={style.title}>Правильных ответов: {audiocallState.correctAnswers.length}</p>
          ...
          <ul className={style.mistakeAnswList}>
            <div className={style.audioCorrect}>
              <p className={style.title}>Неправильных ответов: {audiocallState.counterConditionValue - 1 - audiocallState.correctAnswers.length}</p>
